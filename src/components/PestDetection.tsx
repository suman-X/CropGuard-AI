  ...
  return (
    <>
      <div className="grid md:grid-cols-2 gap-8">
        {/* Upload Section */}
        <Card className="border border-zinc-800 bg-zinc-950 hover:border-white/20 transition-all duration-300">
          <CardHeader>
            <CardTitle className="flex items-center gap-2 text-zinc-100">
              <Camera className="h-5 w-5 text-zinc-100" />
              Capture or Upload
            </CardTitle>
          ...
          <CardContent className="space-y-4">
            {!selectedImage ? (
              <div className="space-y-3">
                <Button
                  onClick={openCamera}
                  className="w-full h-24 bg-zinc-100 text-black hover:bg-zinc-200 border border-transparent hover:border-zinc-300 transition-all"
                  size="lg"
                >
                ...
                <Button
                  ...
                  variant="outline"
                  className="w-full h-24 bg-zinc-950 border-zinc-800 text-zinc-100 hover:bg-zinc-900 hover:text-white hover:border-zinc-700 transition-all"
                  size="lg"
                >
